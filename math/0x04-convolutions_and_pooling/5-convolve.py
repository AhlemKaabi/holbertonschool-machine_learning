...
def convolve(images, kernels, padding='same', stride=(1, 1)):
    ...
    @kernel(numpy.ndarray), shape (kh, kw, c, nc)
    ...
    kernel_h, kernel_w, kernel_c, ker_nb_c = kernels.shape
    sh, sw = stride
    ...
    # convolution output
    output = np.zeros((m, output_height, output_width, ker_nb_c))
